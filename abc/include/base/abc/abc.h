...
static inline Abc_Obj_t * Abc_ObjFanin2( Abc_Obj_t * pObj )          { return (Abc_Obj_t *)pObj->pNtk->vObjs->pArray[ pObj->vFanins.pArray[2] ];   }
static inline Abc_Obj_t * Abc_ObjFanin3( Abc_Obj_t * pObj )          { return (Abc_Obj_t *)pObj->pNtk->vObjs->pArray[ pObj->vFanins.pArray[3] ];   }
...
extern ABC_DLL void 			  Abc_NtkDfs_rec( Abc_Obj_t * pNode, Vec_Ptr_t * vNodes );
extern ABC_DLL void 			  Abc_NtkDfsReverse_rec( Abc_Obj_t * pNode, Vec_Ptr_t * vNodes );
...
extern ABC_DLL void				  Abc_NodeMffcConeSuppPrint( Abc_Obj_t * pNode );
/*=== abcRefactor.c ==========================================================*/
...
extern ABC_DLL Vec_Int_t * 		  Abc_NtkDelayTraceSlackStart( Abc_Ntk_t * pNtk );
extern ABC_DLL void 			  Abc_NtkTimePrepare( Abc_Ntk_t * pNtk );
extern ABC_DLL void 			  Abc_NodeDelayTraceArrival( Abc_Obj_t * pNode, Vec_Int_t * vSlacks );
extern ABC_DLL int 		 		  Abc_NtkDelayTraceCritPath_rec( Vec_Int_t * vSlacks, Abc_Obj_t * pNode, Abc_Obj_t * pLeaf, Vec_Int_t * vBest );
extern ABC_DLL void 			  Abc_NtkDelayTraceCritPathCollect_rec( Vec_Int_t * vSlacks, Abc_Obj_t * pNode, Vec_Int_t * vBest, Vec_Ptr_t * vPath );
...
/*=== abcFunc.c ==========================================================*/
extern ABC_DLL void *	 		  Abc_ConvertSopToBdd( void * dd, char * pSop, void * pbVars );

/*=== abcShow.c ==========================================================*/
extern ABC_DLL void				  Abc_NtkShow( Abc_Ntk_t * pNtk, int fGateNames, int fSeq, int fUseReverse );
extern ABC_DLL void 			  Abc_NodeShowBddOne( void * dd, void * bFunc );
extern ABC_DLL void 			  Abc_NodeShowBdd( Abc_Obj_t * pNode );
